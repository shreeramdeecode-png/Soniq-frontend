    ...
    <div className="glossy-card p-[12px_14px] rounded-[16px]">
      ...
      <div className="flex items-center justify-between mb-2.5">
        ...
        <div className="flex gap-[5px]">
          <button className="w-6 h-6 rounded-[7px] border border-black/[0.08] flex items-center justify-center cursor-pointer bg-white/60">
          ...
          return (
            <div
              ...
              className={cn(
                ...
                item.active && 'outline-[2.5px] outline outline-primary outline-offset-2'
              )}
            >
              {/* Image */}
              <div
              ...
              <div className={cn(
                ...
                item.active ? 'font-bold text-text-primary' : 'text-text-secondary'
              )}>
                {item.time}
              </div>
            </div>
