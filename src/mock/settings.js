export const employees = [
  ...
  { init: 'AM', name: 'Arjun Mehta', email: 'arjun@acme.com', team: 'Engineering', role: 'Manager', mode: 'Remote', os: 'macOS', exe: 'v2.4.1', last: '18 min', status: 'active', color: '#E8E0C8', fc: '#888', cap: true, blur: true, interval: 5, idle: true, idleMin: 3, hrs: 8, pHrs: 6, tgt: 82, days: [1, 1, 1, 1, 1, 0, 0] },
  ...
  { init: 'SN', name: 'Sneha Nair', email: 'sneha@acme.com', team: 'Sales', role: 'Employee', mode: 'Office', os: 'Windows', exe: 'v2.3.8', last: '1 hr', status: 'active', color: '#E8E0C8', fc: '#888', cap: true, blur: false, interval: 1, idle: true, idleMin: 5, hrs: 9, pHrs: 6, tgt: 70, days: [1, 1, 1, 1, 1, 1, 0] },
  { init: 'MK', name: 'Meera Kapoor', email: 'meera@acme.com', team: 'Design', role: 'Employee', mode: 'Remote', os: 'Windows', exe: 'v2.3.8', last: '3 hr', status: 'pending', color: '#D8D8D0', fc: '#888', cap: false, blur: false, interval: 10, idle: false, idleMin: 5, hrs: 8, pHrs: 5, tgt: 75, days: [1, 1, 1, 1, 0, 0, 0] },
];
...
export const settingsTeams = [
  ...
  { init: 'DS', name: 'Design', desc: 'UX, UI and visual design', members: 18, score: 76, scoreColor: '#B8860B', ringColor: '#378ADD', ringDash: '50 77', bgColor: 'rgba(55,138,221,.12)', textColor: '#185FA5' },
  { init: 'SL', name: 'Sales', desc: 'Revenue and BD', members: 24, score: 64, scoreColor: '#993535', ringColor: '#639922', ringDash: '66 61', bgColor: 'rgba(61,96,40,.12)', textColor: '#3B6D11' },
  { init: 'PR', name: 'Product', desc: 'Product management', members: 12, score: 83, scoreColor: '#B8860B', ringColor: '#7F77DD', ringDash: '34 93', bgColor: 'rgba(83,74,183,.12)', textColor: '#534AB7' },
  { init: 'SP', name: 'Support', desc: 'Customer success', members: 20, score: 71, scoreColor: '#B8860B', ringColor: '#D85A30', ringDash: '56 71', bgColor: 'rgba(216,90,48,.12)', textColor: '#993C1D' },
];
...
export const roleMeta = {
  ...
  manager: { title: 'Manager — Module Permissions', sub: '12 members · editable role', edit: true, label: 'M', labelColor: '#185FA5', labelBg: 'rgba(55,138,221,.12)', badge: 'Editable', badgeClass: 'db', members: 'Restricted · 12 members' },
  viewer: { title: 'Viewer — Module Permissions', sub: 'Custom role · 8 members', edit: true, label: 'V', labelColor: '#534AB7', labelBg: 'rgba(83,74,183,.1)', badge: 'Custom · editable', badgeClass: 'dp', members: 'Read-only · 8 members' },
...
export const settingsGroups = [
  ...
  { id: 'work', name: 'Work & Monitoring', color: '#3B6D11', count: '3 sections' },
  { id: 'access', name: 'Access & Controls', color: '#534AB7', count: '2 sections' },
];
